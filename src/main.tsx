...
function App() {
  ...
  return <main ref={root}>
    ...
    <section className="ending panel"><Photo memory={memories[6]} className="end-photo"/><div><h2>With lots of love.<br/><em>Harry Jees</em></h2><p>AKA Pakal manyan</p></div></section>
  </main>;
}
